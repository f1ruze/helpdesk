                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">@lang("backend.titles.donations")</h3>
                        </div>
                    </div>
...
@section('scripts')
    ...
    @include('backend.includes.plugins.datatable',['columns'=>['id','ip_address','total_amount','actions'], 'route'=>route('backend.donations.index')])
@endsection
