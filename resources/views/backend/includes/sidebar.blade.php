    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                @can('tickets index')
                    <li class="menu-item{{ url()->current() ==  route('backend.tickets.index') ? ' menu-item-active' : '' }}"
                        aria-haspopup="true">
                        <a href="{{ route('backend.tickets.index') }}" class="menu-link">
                                            <span class="svg-icon menu-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                     width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                @can('departments index')
                    <li class="menu-item{{ url()->current() == route('backend.departments.index') ? ' menu-item-active' : '' }}"
                        aria-haspopup="true">
                        <a href="{{ route('backend.departments.index') }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                @can('faculties index')
                    <li class="menu-item{{ url()->current() == route('backend.faculties.index') ? ' menu-item-active' : '' }}"
                        aria-haspopup="true">
                        <a href="{{ route('backend.faculties.index') }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
