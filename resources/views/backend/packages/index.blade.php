        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="card card-custom">
                    @include('backend.includes.card.header', ['page' => 'packages'])
                    @include('backend.packages.tables.index')
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    @include('backend.includes.plugins.datatable',['columns'=>['id','type','condition','actions'], 'route'=>route('backend.packages.index')])
@endsection
