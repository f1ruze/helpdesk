        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <div class="card card-custom">
                    ...
                    @include('backend.tickets.tables.index')
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    @include('backend.includes.plugins.datatable',['columns'=>['id','faculty','department','teacher','student','email','type','category','priority','message','actions'], 'route'=>route('backend.tickets.index')])
@endsection
